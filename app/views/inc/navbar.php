    ...
    <nav class="main_nav">
        <ul class="nav_items">
            ...
            <div class="dropdown" style="float:right;">
                <li class="nav_item dropbtn"><a href="<?php echo URLROOT; ?>/wisdom/chapters" id="chapters"
                        class="nav_item_item">Chapters</a></li>
                <div class="dropdown-content">
                    ...
                    <a href="<?php echo URLROOT; ?>/wisdom/spirituality">Spirituality</a>
                </div>
            </div>
            <li class="nav_item"><a href="<?php echo URLROOT; ?>/participate/start" id="participate"
